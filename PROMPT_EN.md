...
### Section-by-section holistic review:
For each section, list Weaknesses (ranked by importance) and Strengths. Think like an ICML/NeurIPS reviewer.
...
3. **Part B: LLM Review** — content, language, visual, layout, section-by-section holistic review
4. **Part C: Reference Verification** — per-entry results with verification URLs
